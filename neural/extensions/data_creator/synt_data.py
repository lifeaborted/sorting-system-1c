"""
Создание искусственных данных для датасета
"""
...
# --- НАСТРОЙКИ ---
source_image_path = "extensions/data_creator/image"
output_dir = "extensions/data_creator/synthetic_dataset"
class_name = "marking"
class_id = 0  # ID класса (обычно 0)
num_images_to_generate = 50 #Количество фото
# -----------------
...
img = cv2.imread(next(iter(glob.glob(f'{source_image_path}/*')), None))
print(f'{source_image_path}/*')
if img is None:
...
label_path = f"{source_image_path}/*".replace(".jpg", ".txt")
print(label_path)
